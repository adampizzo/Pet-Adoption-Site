...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///db/pets.db'
...
class Pet(db.Model):
    ...
    def clone(self): #Attribution to Emmv and Mark Amery : https://stackoverflow.com/questions/28871406/how-to-clone-a-sqlalchemy-object-with-new-primary-key
